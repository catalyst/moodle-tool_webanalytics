...
$string['scriptendpoint'] = 'Script endpoint filename';
$string['scriptendpoint_help'] = 'Enter the script endpoint filename, such as piwik.js or matomo.js. If left blank, piwik.js is used.';
...
$string['trackerendpoint'] = 'Tracker endpoint filename';
$string['trackerendpoint_help'] = 'Enter the tracker endpoint filename, such as piwik.php or matomo.php. If left blank, piwik.php is used.';
