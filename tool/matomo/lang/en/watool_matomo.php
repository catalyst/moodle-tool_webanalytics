...
$string['scriptendpoint'] = 'Alternative script endpoint filename';
$string['scriptendpoint_help'] = 'Enter alternative script endpoint filename (optional), such as piwik.js or matomo.js. If left blank, piwik.js is used.';
...
$string['trackerendpoint'] = 'Alternative tracker endpoint filename';
$string['trackerendpoint_help'] = 'Enter alternative tracker endpoint filename (optional), such as piwik.php or matomo.php. If left blank, piwik.php is used.';
$string['urloverridesdesc'] = 'Override the default Matomo URLs and endpoint filenames. Leave these blank to use the defaults.';
$string['urloverridesheader'] = 'URL overrides';
